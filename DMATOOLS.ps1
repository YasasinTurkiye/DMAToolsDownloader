...
$Groups = [ordered]@{
    'DMA Forensics' = @(
        'https://github.com/YasasinTurkiye/WeLoveDMABypassers/releases/download/DMATOOLS/Aim.Device.Scanner.exe'
        'https://github.com/YasasinTurkiye/WeLoveDMABypassers/releases/download/DMATOOLS/TLP.Contactor.exe'
        'https://github.com/YasasinTurkiye/WeLoveDMABypassers/releases/download/DMATOOLS/DMA-multitool.exe'
        'https://github.com/YasasinTurkiye/WeLoveDMABypassers/releases/download/DMATOOLS/Hash.History.Scanner.exe'
        'https://github.com/YasasinTurkiye/WeLoveDMABypassers/releases/download/DMATOOLS/Setup.Api.Dev.Analyzer.exe'
        'https://github.com/YasasinTurkiye/WeLoveDMABypassers/releases/download/DMATOOLS/RAM.DUMP.Analyzer.exe'
    )
  }
